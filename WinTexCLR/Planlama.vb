...
Module Planlama
    ...
    Public Function LoadTatiller() As Date()
    ...
    Private Sub UretimPlLinesKapat(nSiraNo As Double, dTarih As Date, Optional cSiparisno As String = "")
        ...
        Try
            ...
            ' Bağlı işemri satırlarını kapatmayı öner
            cSql = "update isemrilines " + _
                    " set kapatilmasionerilsin = 'E' " + _
    ...
    Public Sub OtomatikKapatmalar(Optional cSiparisno As String = "")
        ...
        Try
            ...
            If cSTF.Trim <> "" Then
                ' sevkedilmiş adet, sevkedilecek adedi karşıladıysa kapatılır
            ...
            cUTF = GetOpenUTFFromSiparisNo(cSiparisno)
            If cUTF.Trim <> "" Then
                ' üretilen adet, üreilecek adedi karşıladıysa kapatılır
                cSQL = "select SiraNo " + _
                        " from uretpllines " + _
            ...
            If cMTF.Trim <> "" Then
                ...
                ' üretime çıkan malzeme ihtiyacı karşılamışsa kapatılır
                cSQL = "select SiraNo " + _
                        " from mtkfislines " + _
