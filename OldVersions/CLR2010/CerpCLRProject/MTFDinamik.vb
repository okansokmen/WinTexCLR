...
Module MTFDinamik
    ...
    Public Function GetToplamSiparisView_1(Optional cFilter As String = "", Optional ByRef cTable As String = "", Optional ConnYage As SqlConnection = Nothing) As Integer
        ...
        Try
            ...
            cSQL = cSQL + _
                    ...
                    " ), "
            ' üretimden iade edilen malzeme satırında bir açıklama yoksa
            ...
            ' MTF kapatmaya güvenmediğimiz için stoklarda kapanmamış MTF ler bakılmaz
            cSQL = cSQL + _
    ...
    Public Function MTFHesaplax_1(Optional cFilter1 As String = "", Optional cFilter2 As String = "", Optional cTSip As String = "", Optional ByRef cMTFHesaplaX As String = "", Optional ConnYage As SqlConnection = Nothing) As Integer
        ...
        Try
            ...
            '    cSQL = "select sum(coalesce(b.miktar1,0)) " + _
            '            " from isemri a, isemrilines b " + _
            '            " where a.isemrino = b.isemrino " + _
            '            " and b.stokno = '" + aStokRB(nCnt).cStokno + "' " + _
            '            " and b.renk = '" + aStokRB(nCnt).cRenk + "' " + _
            '            " and b.beden = '" + aStokRB(nCnt).cBeden + "' " + _
            '            " and b.malzemetakipno = '" + aStokRB(nCnt).cMTF + "' "

            '    aStokRB(nCnt).nIsemriVerilen = SQLGetDoubleConnected(cSQL, ConnYage)
            'Next
